(() => {
  const dict = {
    fr: {
      ...
      'work.superfans.sub': 'Plateforme de monétisation directe pour les créateurs africains',
      'work.afg.sub': "Application mobile bancaire · 5 pays · Architecture, backend, management d'équipe",
      'work.eassur.title': 'AFG Groupe E-Assur',
      'work.eassur.sub': "Souscription d'assurance non-vie · web et mobile · 5 pays · Architecture, backend, management d'équipe",
      'work.idole.sub': "Transferts d'argent et marketplace de colis pour la diaspora · 11 pays",
      'work.presidence.title': 'Présidence du Bénin',
      'work.presidence.sub': "Plateforme RH et finances · Architecture, DevOps, management d'équipe · sous NDA",
      'work.etchite.sub': "Gestion d'activité et comptabilité SYSCOHADA pour les MPME · CCI Bénin",
      'work.rema.sub': "La plus grande communauté médicale d'Afrique",
      'work.oremi.sub': "Plateforme d'assurance digitale · Atlantique Assurances",
    ...
    en: {
      ...
      'work.superfans.sub': 'Direct monetization platform for African creators',
      'work.afg.sub': 'Mobile banking app · 5 countries · Architecture, backend, engineering management',
      'work.eassur.title': 'AFG Groupe E-Assur',
      'work.eassur.sub': 'Non-life insurance subscription · web and mobile · 5 countries · Architecture, backend, engineering management',
      'work.idole.sub': 'Money transfer and parcel marketplace for the diaspora · 11 countries',
      'work.presidence.title': 'Presidency of Bénin',
      'work.presidence.sub': 'HR and finance platform · Architecture, DevOps, engineering management · under NDA',
      'work.etchite.sub': 'Business management and SYSCOHADA accounting for MSMEs · CCI Bénin',
      'work.rema.sub': 'The largest medical community in Africa',
      'work.oremi.sub': "Digital insurance platform · Atlantique Assurances",
