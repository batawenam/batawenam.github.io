(() => {
  const dict = {
    fr: {
      ...
      'work.kasua.sub': 'App mobile de gestion financière pour micro-commerçants peu alphabétisés',
    ...
    en: {
      ...
      'work.kasua.sub': 'Mobile finance app for low-literacy micro-merchants',
